# Glossary — every term the film defines, and where
...
|---|---|---|
| **revenue** | All the money coming in, before anything is taken out. | 1 — What “investment” actually means |
| **cost** | All the money going out to keep the place running. | 1 — What “investment” actually means |
| **profit** | Revenue minus cost. What is left over. | 1 — What “investment” actually means |
| **fixed cost** | A cost that does not change with how much you make. | 1 — What “investment” actually means |
| **variable cost** | A cost that rises and falls with how much you make. | 1 — What “investment” actually means |
| **investment** | Spending a large sum now to build something that earns later. | 1 — What “investment” actually means |
| **average variable cost** | What each extra chair costs her to make. | 2 — The textbook rule |
| **long-run average cost** | Everything a chair costs, the building included. | 2 — The textbook rule |
| **cost of capital** | The yearly percentage her money must earn to be worth using. | 2 — The textbook rule |
| **hurdle rate** | The return a firm insists a project must promise. | 3 — Three facts that don’t fit |
| **exchange rate** | How much of one country's money another's will buy. | 3 — Three facts that don’t fit |
| **imports** | Goods made abroad and sold here. | 3 — Three facts that don’t fit |
| **sunk cost** | Money that cannot be got back if you change your mind. | 4 — The three ingredients |
| **ongoing uncertainty** | You do not know what is coming, and you learn a little at a time. | 4 — The three ingredients |
| **the chance keeps** | The opportunity does not vanish if you do not take it today. | 4 — The three ingredients |
